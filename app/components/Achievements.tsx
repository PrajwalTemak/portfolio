...
export default function Achievements({ achievements }: AchievementsProps) {
  const defaultAchievements: Achievement[] = [
    ...
    {
      id: '2',
      title: 'Runner-Up, Institute level hackathon',
    },
    {
      id: '3',
    ...
    {
      id: '4',
      title: 'Second rank holder of diploma in Information Technology',
      description: 'Government Polytechnic, Pune with 93.67%',
    },
  ]
